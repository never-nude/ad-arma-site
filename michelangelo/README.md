# Michelangelo Collection (Chronological)

Institution-sourced 3D model pages in chronological order.

1. Michelangelo: Battle of the Centaurs (c.1490-1492)
   - /michelangelo/battle-of-the-centaurs/
2. Michelangelo: Bacchus (1496-1497)
   - /michelangelo/bacchus/
3. Michelangelo: Pieta (1498-1499)
   - /michelangelo/pieta/
4. Michelangelo: David (1501-1504)
   - /michelangelo/david/
5. Michelangelo: Bruges Madonna (1501-1504)
   - /michelangelo/bruges-madonna/
6. Michelangelo: Moses (1513-1515)
   - /michelangelo/moses/
7. Michelangelo: Dying Slave (1513-1516)
   - /michelangelo/dying-slave/
8. Michelangelo: Rebellious Slave (1513-1516)
