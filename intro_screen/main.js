...
function unitColors(side) {
  ...
  function prepareQuickStartDoctrine() {
    const recommended = buildCompleteDoctrineLoadout(makeRecommendedDoctrineLoadout());
    setDoctrineLoadoutForSide('blue', recommended, 'recommended');
    setDoctrineLoadoutForSide('red', recommended, 'recommended');
